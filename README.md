...
- <img src="https://avatars.githubusercontent.com/u/268872132?v=4" height="14"/> [Novada MCP](https://github.com/NovadaLabs/novada-mcpserver) - Hosted Streamable-HTTP MCP server with 25+ web-data tools: search, SERP, scrape, extract, map, crawl, research, and 6 proxy types across 100M+ IPs in 195 countries. One URL, zero install, 1,000 free calls/month. `npx novada-mcp`
